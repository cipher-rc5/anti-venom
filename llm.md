...
## File: .config.example
````
evm_addr = null  # Your default EVM address
default_limit = 25
cache_dir = "~/.cache/evm-transactions"
address_book_path = "address_book.csv"
retry_attempts = 3
retry_delay_ms = 1000
parallel_workers = 10
default_format = "table"
timestamp_format = "unix"  # relative, unix, human
sort_by = "block_time"
sort_order = "desc"
...
## File: .env.example
````
# Your EVM address (optional - can also be set in config.toml or passed as argument)
EVM_ADDR=0xYourAddressHere

# API Keys (required)
SIM_API_KEY=your-actual-dune-api-key 

# API Keys (optional - enables translation)
NOVES_API_KEY=your-actual-noves-api-key
````
...
0xA090e606E30bD747d4E6245a1517EbE430F0057e,eth,Coinbase
````
